...
layui.define("jquery",
    function(e) {
        ...
        var o = layui.jquery,
            ...
            expand = function(treeNode, isOpened, e) {
                ...
                if (subTreeNodes && subTreeNodes.length > 0) {
                    for (var ind = 0; ind < subTreeNodes.length; ind++) {
                        ...
                        if (subTrNode) { ! isOpened ? (e.data("spread", null), subTrNode.setAttribute('class', 'layui-hide')) : (e.data("spread", !0), subTrNode.setAttribute('class', ''))
                        }
                        if (isOpened && !subTreeNode.isOpened) {
                            continue;
                        }
                        expand(subTreeNode, isOpened, e);
                    }
                }
            };
        i.prototype.traverseModel = function(treeTable, parentNode, item, childrenAttrs) {
            ...
            i.prototype.initGird = function(e) {
                ...
                o.options.skin && e.addClass("layui-tree-skin-" + o.options.skin),
                    ...
                    e.wrapInner('<div class="layui-form" id="treetable"></div>'),
                    o.on(e);
            },
                ...
                layui.each(n,
                    function(a, n) {
                        ...
                        "function" == typeof i.click && r.click(s, n),
                            r.spread(s, n),
                        //TODO i.drag && r.drag(s, n) r.changed(s, n)
                        i.drag && r.drag(s, n) ,r.changed(s, n)
                    })
            },
            i.prototype.treeGird = function(e, a) {
                ...
                layui.each(n,
                    function(a, n) {
                        ...
                        var p = treeNode.parentId == 'root' ? null: treeNode.parentId,
                        ...
                        e.append(str),
                            index++,
                        l && (r.treeGird(e, n.children)),
                            r.spreadGird(str, n),
                        //TODO i.drag && r.drag(str, n) r.changed(str, n)
                        i.drag && r.drag(str, n), r.changed(str, n)
                    })
            },
                    ...
                    for (var j = 0,
                        ...
                        if (childrendInputs[j].getAttribute("data-parent-id") != "undefined") {
                            if (childrendInputs[j].checked) {
                                //TODO console.log(1158) ,hasOneChildrenInputCheck = true;
                                console.log(1158) ,hasOneChildrenInputCheck = true;
                                break;
                            }
                        }
                    }
            ...
            i.prototype.spreadGird = function(e, o) {
                var a = this,
                    ...
                    l = function() {
                        ...
                        expand(treeNode, !isOpened, e);
                        //TODO isOpened ? (e.data("spread", null), r.html(t.arrow[0]), ri.html(t.branch[0])) : (e.data("spread", !0), r.html(t.arrow[1]), ri.html(t.branch[1])) treeNode.isOpened = !isOpened;
                        isOpened ? (e.data("spread", null), r.html(t.arrow[0]), ri.html(t.branch[0])) : (e.data("spread", !0), r.html(t.arrow[1]), ri.html(t.branch[1])) ,treeNode.isOpened = !isOpened;
                    }; (r.on("click", l))
            },
            ...
            e("treeGird",
                function(e) {
                    var r = new i(e = e || {}),
                        t = o(e.elem);
                    return t[0] ? void r.initGird(t) : a.error("layui.tree 没有找到" + e.elem + "元素");
                })
    });